...
const SignupForm: React.FC = () => {
  ...
  return (
    <div
      //className="relative m-10 flex min-h-screen flex-col items-center justify-center bg-white"
    ...
    >
      ...
      <div className="m-10 rounded-[30px] bg-store-white p-[40px_30px_45px] shadow-custom max-sm:p-[30px_25px_40px] max-[420px]:p-[25px_15px]">
        <Link href="/" className="flex justify-center self-center text-center">
          <Image
            loading="lazy"
            ...
            <div className="mb-[20px] max-sm:mb-[10px]">
              ...
              <div className="relative">
                ...
                <span
                  ...
                  onClick={() =>
                    setVisibleField(
                      visibleField === 'confirm' ? null : 'confirm',
                    )
                  }
                >
                  <Image
