...
const HowWorks: React.FC<WorksProps> = ({
  ...
  return (
    <section className="bg-buy-sourcing-lightskyblue p-[120px_0px_120px] max-xl17:p-[50px_0px_50px] max-xl:p-[40px_0px_40px] max-lg:p-[30px_0px_30px] max-sm:p-[50px_0px_35px]">
