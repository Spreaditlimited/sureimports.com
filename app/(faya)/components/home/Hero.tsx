            ...
            <div className="hide-scrollbar flex w-full items-center gap-5 overflow-x-auto sm:flex-col sm:items-start sm:gap-0">
              {['Up to 60W Power', 'Ultra-Fast Charging', 'Built to Last'].map(
                (it, idx) => (
                  <h3
                    key={idx}
                    className={`text-gradient flex w-full items-center gap-2.5 whitespace-nowrap py-4 text-center text-[20px] font-medium leading-[160%] sm:py-6 sm:text-start sm:text-[36px] sm:leading-[150%] lg:py-9 ${
