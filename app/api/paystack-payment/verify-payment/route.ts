...
export async function POST(request: Request) {
  try {
    ...
    const store = await prisma.store_sales.update({
    ...
    const xBody1 = `Thank you for your order on the <b>Sureimports.com shop. </b></i>`;
    ...
    const xBody1B = `Hi Admin, <br />an order has been placed on the sureimports.com shop.</b><br />`;
