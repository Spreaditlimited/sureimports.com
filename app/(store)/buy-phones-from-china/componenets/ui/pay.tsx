          ...
          <div className="grid grid-cols-12 gap-[5px] max-xl17:gap-[20px] max-lg:gap-[30px_10px]">
            ...
            <div className="col-span-4 max-lg:col-span-12">
              ...
              >
                ...
                <p className="text-gray mt-[20px] max-w-[511px] text-[18px] font-medium leading-[166%] max-xl:text-[16px] max-lg:mx-auto max-sm:mt-[15px] max-sm:text-store-black">
            ...
            <div className="col-span-4 max-lg:col-span-12">
              ...
              >
                <div>
                  <div className="inline-flex items-center justify-center rounded-[29px] bg-store-lightskyblue p-[12px_30px]">
                    <Image src={payicon} alt="icon" />
                    <span className="pl-[20px] text-[18px] font-medium leading-[155%] text-store-blue max-[420px]:text-[15px]">
                      Pay in Full
                    </span>
                  </div>
                  <div className="pay-list mt-[45px] max-sm:mt-[30px]">
                    <ul className="flex flex-col gap-[20px]">
                      {payListItems.map((item, index) => (
                        <li
                          key={index}
                          className="text-gray pl-[40px] text-[16px] font-normal leading-[150%] max-sm:text-store-black"
                        >
                          {item}
                        </li>
                      ))}
            ...
            <div className="col-span-4 max-lg:col-span-12">
              <div
                className="ml-auto flex h-full w-full max-w-[499px] flex-col justify-between rounded-[30px] border border-solid border-[#F4F4F4] bg-store-blue p-[40px_40px_35px] shadow-cardshadow2 max-xl:p-[30px_25px] max-lg:mx-auto"
                data-aos="fade-up"
              >
                  ...
                  <div className="pay-list mt-[45px] max-sm:mt-[30px]">
                    <ul className="flex flex-col gap-[20px]">
                      {paySmallListItems.map((item, index) => (
                        <li
                          key={index}
                          className="pl-[40px] text-[16px] font-normal leading-[150%] text-store-white"
                        >
                          {item}
                        </li>
                      ))}
                ...
                <div className="mt-[50px] max-sm:mt-[30px]">
                  <Whitebtn
                    ...
                    className="w-full text-store-blue max-xl:p-[12px_18px] max-xl:text-[16px] max-[420px]:text-[14px]"
                  />
                </div>
              </div>
            </div>
