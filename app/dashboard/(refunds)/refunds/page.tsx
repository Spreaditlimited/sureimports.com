          ...
          <div className="bg-card rounded-[20px] border border-border shadow-sm mb-6 sm:mb-8">
            <div className="p-6 sm:p-8">
              <div className="flex flex-row items-center justify-between gap-4 lg:gap-6">
                <div className="flex-1 min-w-0">
                  <p className="text-sm sm:text-base text-muted-foreground mb-1 sm:mb-2  text-black dark:text-slate-400">
                    Total Amount {selectedFilter !== "All" && `(${selectedFilter})`}
                  </p>
                  <p className="text-xl sm:text-2xl lg:text-3xl font-semibold text-foreground text-black dark:text-slate-400">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 lg:gap-4">
                  ...
                  <div className="relative z-50" ref={dropdownRef}>
                    ...
                    >
                      ...
                      <span className="text-base sm:text-lg font-medium text-foreground flex-1 text-left  text-black dark:text-slate-400">{selectedFilter}</span>
          ...
          <div className="bg-card rounded-[20px] border border-border shadow-sm">
            ...
            <div className="overflow-x-auto max-h-[600px] overflow-y-auto">
              <div className="min-w-[800px] text-black dark:text-slate-400">
                {/* Table Header Row */}
                <div className=" text-black dark:text-slate-400 grid grid-cols-5 gap-4 lg:gap-6 xl:gap-8 p-4 sm:p-6 xl:p-8 bg-muted/20 border-b border-border">
                  <div className="font-semibold text-foreground text-black dark:text-slate-400">Refund ID</div>
                  <div className="font-semibold text-foreground text-black dark:text-slate-400">Order ID</div>
                  <div className="font-semibold text-foreground text-black dark:text-slate-400">Amount (NGN)</div>
                  <div className="font-semibold text-foreground text-black dark:text-slate-400">Status</div>
                  <div className="font-semibold text-foreground text-black dark:text-slate-400">Service Type</div>
                </div>
            ...
            {filteredData.length > 0 && (
              <div className="bg-muted/50 border-t border-border p-6 xl:p-8 rounded-b-[20px]">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                  <div className="text-sm sm:text-base text-foreground text-black dark:text-slate-400">
