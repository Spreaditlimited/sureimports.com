            ...
            <div className="max-sm:item-center flex w-full flex-col justify-center gap-3 pb-[25px]">
                  ...
                  <FormField
                    ...
                    render={({ field: { value, onChange, ...fieldProps } }) => (
                      <FormItem className="w-full text-base text-slate-800 dark:text-white">
                        ...
                        <FormControl>
                          <div className="flex">
                            <label className="flex h-[60px] w-full items-center rounded-lg bg-slate-100 pl-5 outline-dashed outline-1 outline-indigo-800 dark:bg-slate-800 max-sm:w-[340px]">
                  ...
                  <FormField
                    ...
                    render={({ field: { value, onChange, ...fieldProps } }) => (
                      <FormItem className="w-full text-base text-slate-600 dark:text-white">
                        ...
                        <FormControl>
                          <div className="flex">
                            <label className="flex h-[60px] w-full items-center rounded-lg bg-slate-100 pl-5 outline-dashed outline-1 outline-indigo-800 dark:bg-slate-800 max-sm:w-[400px]">
              ...
              <div className="flex flex-col pr-[25px] max-md:mt-[25px] max-md:space-y-[25px]">
                ...
                <div className="flex justify-between border-b border-t py-[25px] max-md:flex-col max-md:gap-3">
                  <div>
                    Service Charge: <span className="font-bold">0%</span>
                  </div>
                  <div className="flex gap-4">
                    Exchange Rate:
                    <span className="font-semibold"> ¥1 Yuan</span>=
                    <span className="font-semibold"> ₦200 Naira</span>
                  </div>
                </div>
              </div>
            </div>
            {pathname.includes('saved-payment-request') ? (
