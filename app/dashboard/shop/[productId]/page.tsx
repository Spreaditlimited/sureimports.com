            ...
            <div className="space-y-8">
              ...
              {product.productSpecification && (
                <div>
                  ...
                  <div className="prose prose-sm prose-slate dark:prose-invert max-w-none whitespace-pre-wrap break-words rounded-2xl bg-slate-50 p-6 text-slate-600 [overflow-wrap:anywhere] dark:bg-slate-900/50">
                    {product.productSpecification}
                  </div>
                </div>
              )}
