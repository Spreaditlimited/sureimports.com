        ...
        <DialogHeader>
          ...
          <DialogDescription asChild>
            <div className="space-y-4 text-sm text-muted-foreground">
              <p>
                Your order {orderDetails.orderNumber} has been successfully cancelled and moved to the Cancelled Orders tab.
              </p>
            </div>
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-4 border border-green-200 dark:border-green-800">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-medium text-green-800 dark:text-green-200">Refund Credited Successfully</h4>
                <p className="text-sm text-green-700 dark:text-green-300 mt-1">
                  <span className="font-semibold">{orderDetails.refundAmount}</span> has been automatically credited to your wallet.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-muted rounded-lg p-4">
            <h4 className="font-medium text-foreground mb-3">What you can do with your wallet balance:</h4>
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-center gap-2">
                ...
                <span className="text-muted-foreground">Use it to purchase other products instantly</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-4 h-4 rounded-full bg-purple-100 dark:bg-purple-900/30 flex items-center justify-center">
                  <svg className="w-2.5 h-2.5 text-purple-600 dark:text-purple-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 9V7C17 5.34315 15.6569 4 14 4H10C8.34315 4 7 5.34315 7 7V9M3 11L21 11M5 21H19C20.1046 21 21 20.1046 21 19V13C21 11.8954 20.1046 11 19 11H5C3.89543 11 3 11.8954 3 13V19C3 20.1046 3.89543 21 5 21Z" />
                  </svg>
                </div>
                <span className="text-muted-foreground">Withdraw to your bank account</span>
              </div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-muted-foreground">Combine with other payment methods</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <DialogFooter className="gap-3">
          ...
          >
            <svg className="w-4 h-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 10H21M7 15H1M13 15H21M5 21H19C20.1046 21 21 20.1046 21 19V13C21 11.8954 20.1046 11 19 11H5C3.89543 11 3 11.8954 3 13V19C3 20.1046 3.89543 21 5 21Z" />
            </svg>
            Go to Wallet
          </Button>
        </DialogFooter>
