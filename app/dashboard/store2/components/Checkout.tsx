...
export default function Checkout({ 
  ...
  const isAddressComplete = Object.values(addressForm).every(value => value.trim() !== '');
      ...
      <div className="bg-background mx-auto max-w-7xl px-4 md:px-8 py-6 md:py-12 min-h-screen">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              >
                ...
                <span className="font-medium text-white dark:text-foreground text-sm">
            ...
            <button
              onClick={onBulkBuyer}
              className="bg-purple-600 hover:bg-purple-700 dark:bg-purple-500 dark:hover:bg-purple-600 transition-colors flex items-center gap-2 px-4 py-2 rounded-lg"
            >
              <div className="w-5 h-5">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        ...
        <div className="md:hidden">
          ...
          <div className="flex items-center justify-between px-5 py-4 bg-background border-b border-border">
            ...
            <button
              onClick={onBulkBuyer}
              className="bg-purple-600 hover:bg-purple-700 dark:bg-purple-500 dark:hover:bg-purple-600 transition-colors flex items-center gap-2 px-3 py-2 rounded-lg"
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 bg-input-background dark:bg-input border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:focus:ring-primary focus:border-transparent text-foreground placeholder:text-muted-foreground"
              ...
              <div className="space-y-3">
                <button
                  ...
                  className={`w-full text-left p-4 border rounded-lg transition-all ${
                    isAddressComplete 
                      ? 'border-border hover:border-indigo-500 dark:hover:border-primary hover:bg-indigo-50 dark:hover:bg-primary/10' 
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-blue-100 dark:bg-blue-900/30 rounded-lg flex items-center justify-center">
                      <svg className="w-5 h-5 text-blue-600 dark:text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 10H21V18C21 18.5523 20.5523 19 20 19H4C3.44772 19 3 18.5523 3 18V10ZM3 10V6C3 5.44772 3.44772 5 4 5H20C20.5523 5 21 5.44772 21 6V10M3 10H21M7 15H10" />
                      </svg>
                    </div>
                    <div>
                      <h3 className="font-medium text-foreground">Pay With Paystack</h3>
                      <p className="text-sm text-muted-foreground">Pay securely with your card or bank transfer</p>
                    </div>
                  </div>
                </button>
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-purple-100 dark:bg-purple-900/30 rounded-lg flex items-center justify-center">
                      <svg className="w-5 h-5 text-purple-600 dark:text-purple-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8C13.1046 8 14 7.10457 14 6C14 4.89543 13.1046 4 12 4C10.8954 4 10 4.89543 10 6C10 7.10457 10.8954 8 12 8ZM12 8V21M12 8L16 12M12 8L8 12" />
                      </svg>
                    </div>
                    <div>
                      <h3 className="font-medium text-foreground">Pay from Wallet</h3>
              ...
              {!isAddressComplete && (
                <div className="mt-4 p-3 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg">
                  <p className="text-sm text-amber-800 dark:text-amber-200">
                    <span className="font-medium">Complete your address</span> to enable payment options
                  </p>
                </div>
              )}
            </div>
          ...
          <div className="bg-card rounded-lg shadow-sm border border-border p-6 h-fit">
            ...
            <div className="border-t border-border pt-4 space-y-3">
              ...
              <div className="border-t border-border pt-3 flex items-center justify-between">
                ...
                <span className="text-lg font-semibold text-foreground">₦{total.toLocaleString()}.00</span>
              </div>
            </div>
              ...
              <div className="flex items-center gap-2">
                <div className="w-4 h-4 text-green-600 dark:text-green-400">
                  <svg className="block size-full" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 15V9M12 9L16 13M12 9L8 13M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z" />
                  </svg>
                </div>
                <p className="text-sm text-green-800 dark:text-green-200">
                  <span className="font-medium">Secure checkout</span> - Your information is protected
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="lg:hidden space-y-6 pb-6">
          ...
          <div className="bg-card rounded-lg shadow-sm border border-border p-4">
            ...
            <div className="grid grid-cols-1 gap-4">
              <div>
                <label htmlFor="fullName-mobile" className="block text-sm font-medium text-foreground mb-2">
                  Full Name *
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="phoneNumber-mobile" className="block text-sm font-medium text-foreground mb-2">
                  Phone Number *
                </label>
                <input
                  type="tel"
              ...
              <div>
                <label htmlFor="address-mobile" className="block text-sm font-medium text-foreground mb-2">
                  Street Address *
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="city-mobile" className="block text-sm font-medium text-foreground mb-2">
                  City *
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="state-mobile" className="block text-sm font-medium text-foreground mb-2">
                  State *
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="postalCode-mobile" className="block text-sm font-medium text-foreground mb-2">
                  Postal Code *
                </label>
                <input
                  type="text"
