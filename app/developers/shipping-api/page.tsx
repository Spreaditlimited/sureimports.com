  ...
  return (
    <main className={styles.page}>
      <header className={styles.header}>
        <Link href="/" aria-label="Sure Imports home">
          <Image
      ...
      <div className={styles.layout}>
        ...
        <div className={styles.content}>
          <section className={styles.section} id="authentication">
            ...
            <p>
              Use a secret key created in your affiliate dashboard. Send it from
              your server in the Bearer authorization header. Never place the
              key in browser code, a mobile application bundle, a public
            ...
            <div className={styles.callout}>
              ...
              <span>
                ...
                comes from the authenticated key and is locked when the request
                is accepted.
              </span>
            </div>
          </section>
          ...
          <section className={styles.section}>
            ...
            >
              <p>
                Returns the valid plan IDs and authoritative billing unit for a
                destination. Call this before creating a request.
              </p>
            ...
            >
              <p>
                ...
                assigns the accepted request to the affiliate account behind the
                API key.
              </p>
              <div className={styles.parameters}>
                <div>
            ...
            >
              <p>
                ...
                authenticated affiliate. Requests belonging to another affiliate
                are never exposed.
              </p>
            </Endpoint>
          </section>
          ...
          <section className={styles.section} id="ownership">
            ...
            <p>
              The API key permanently establishes who owns the opportunity. When
              the resulting shipping invoice is fully paid, commission is
            ...
            <ul>
              ...
              <li>
                Duties, storage, verification, penalties, and unrelated fees are
                excluded.
              </li>
              <li>
          ...
          <section className={styles.section} id="errors">
            ...
            <div className={styles.errors}>
              ...
              <code>409</code>
              <p>
                Idempotency key or external reference conflicts with an existing
                request.
              </p>
              <code>429</code>
              <p>
      ...
      <footer className={styles.footer}>
        <span>Sure Imports Partner API</span>
        <p>Recommend responsibly. Earn transparently.</p>
        <a href="mailto:support@sureimports.com">Developer support</a>
      </footer>
    </main>
  );
}
