...
export default function Faq() {
  ...
  return (
    <section className="sm:py-15 xl:py-30 bg-white py-[10px] xl:mt-0">
      <div className="container">
        <div className="mx-auto max-w-[1592px]">
          <h2 className="text-gradient-dark mx-auto mb-[5px] w-fit text-center text-[32px] font-semibold leading-[131%] md:text-[36px] md:leading-[152%] lg:mx-0 lg:text-start">
