...
export default function RetailPriceBuilder() {
  ...
  return (
    ...
    >
      ...
      >
        Turn your landed cost per unit into a confident selling price. This tool
        accounts for fees, marketing cost, and a buffer, then calculates a
        retail price that matches your margin target.
      </p>
      ...
      <section className="card">
        <div>
          ...
          <div className="pillRow">
            <button
              type="button"
              className={`pill ${currency === 'USD' ? 'pillActive' : ''}`}
            ...
            <button
              type="button"
              className={`pill ${currency === 'NGN' ? 'pillActive' : ''}`}
          ...
          >
            This does not convert exchange rates. It only changes the currency
        ...
        <div className="twoCol">
          ...
          <div>
            ...
            <input
              value={paymentFeesPct}
              onChange={(e) => setPaymentFeesPct(e.target.value)}
              inputMode="decimal"
              placeholder="e.g. 1.5"
              style={inputStyle}
            />
        ...
        <div>
          ...
          <input
            value={resellerDiscountPct}
            onChange={(e) => setResellerDiscountPct(e.target.value)}
            inputMode="decimal"
            placeholder="e.g. 15"
            style={inputStyle}
          />
          ...
          >
            If you sell to resellers, this estimates a reseller price based on a
            discount off retail.
          </div>
        </div>
        ...
        >
          ...
          {!result ? (
            ...
            <div style={{ display: 'grid', gap: 8, lineHeight: 1.75 }}>
              ...
              <div>
                <b>Margin achieved:</b>{' '}
                {nf2.format(result.marginAchieved * 100)}%
              </div>
      ...
      >
        ...
        <p style={{ margin: '0 0 12px', opacity: 0.86, lineHeight: 1.75 }}>
          The biggest pricing mistake importers make is using supplier price as
          their “cost price.” Your real cost is your landed cost plus the hidden
          costs of selling: marketing, payment fees, returns, and unexpected
          losses. If you price too low, you will sell fast and still go broke.
          If you price too high, you will struggle to sell.
        </p>

        <p style={{ margin: '0 0 12px', opacity: 0.86, lineHeight: 1.75 }}>
          This Retail Price Builder helps you work backwards from the margin you
          want. It estimates a selling price that covers costs, includes a
          buffer, and still hits your profit target. It also shows your
          break-even price and a recommended discount floor, so you don’t
          discount into losses.
        </p>
