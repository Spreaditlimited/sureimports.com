...
export default function BodyCameraVideo() {
  ...
  return (
    ...
    >
      <div className="mx-auto grid si-public-inner overflow-hidden rounded-[2rem] bg-[#0b1930] text-white shadow-[0_30px_80px_rgba(8,20,40,0.16)] lg:grid-cols-[0.68fr_1.32fr]">
