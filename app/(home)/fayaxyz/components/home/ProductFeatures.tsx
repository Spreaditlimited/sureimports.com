...
export default function ProductFeatures({
  ...
  return (
    <section className="sm:py-15 xl:py-30 bg-white p-5 py-[50px]">
      <div className="containerx">
        ...
        >
          ...
          <div className="flex w-full flex-row justify-center space-x-2 px-4 sm:space-x-4">
            <Button
              href="/faya#buy-now"
              className="flex-1 whitespace-nowrap !px-5 text-sm sm:flex-none sm:!px-[70px] sm:text-base"
            >
              Buy Now
            </Button>
            ...
            <Button
              variant="outline"
              className="flex-1 whitespace-nowrap !px-5 text-sm sm:flex-none sm:!px-[70px] sm:pr-10 sm:text-base"
