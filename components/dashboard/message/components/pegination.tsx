...
const PaginationBar: React.FC<PaginationProps> = ({
  ...
  return (
    <Pagination className="max-w-1/4 flex flex-col items-center justify-between rounded-b-xl border-b border-l border-r bg-white py-5 pl-[25px] pr-[25px] dark:bg-[#161629] lg:flex-row">
