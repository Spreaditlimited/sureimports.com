...
const Section1: React.FC<PaySupplierSectionProps> = ({
  ...
  return (
    <div className="flex w-full items-center justify-center bg-white px-32 py-40 max-xl:px-12 max-lg:px-10 max-md:mt-0 max-md:max-w-full max-md:px-5 max-md:pb-5 max-md:pt-20">
