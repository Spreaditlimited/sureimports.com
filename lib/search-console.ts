...
export async function ensureSearchConsoleTables() {
  ...
  await prisma.$executeRawUnsafe(`
    INSERT IGNORE INTO seo_linkable_pages (
      ...
      ('SEOLINK_LINESCOUT_WHITE_LABEL', 'https://linescout.sureimports.com/white-label', 'https://linescout.sureimports.com/white-label', 'LineScout White Label Sourcing', 'active', 'system', CURRENT_TIMESTAMP(3), CURRENT_TIMESTAMP(3), CURRENT_TIMESTAMP(3)),
